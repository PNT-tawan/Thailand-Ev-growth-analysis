...
### Data Source
ข้อมูลที่ใช้เป็นการนำข้อมูลสถิติการจดทะเบียนรถใหม่ตามกฎหมายว่าด้วยรถยนต์ของกรมขนส่งทางบก ข้อมูลสถิติการใช้พลังงานของสำนักงานนโยบายและแผนพลังงาน (สนพ.) กระทรวงพลังงาน โดยเจาะจงที่ข้อมูลรายปีว่าด้วยปริมาณการใช้น้ำมันเบนซินเฉลี่ยต่อวันเป็นหลัก และข้อมูลปริมาณการนำเข้าน้ำมันดิบและวัตถุดิบ เพื่อใช้ในการผลิตน้ำมันสำเร็จรูป ที่จัดทำขึ้นโดยกลุ่มประมวลข้อมูล กองบริการธุรกิจและการสำรองน้ำมันเชื้อเพลิง (กบส.)
...
![](https://github.com/PNT-tawan/image-for-miniproject-5001/blob/main/Figure%202.2.1.png)

>Figure 2.2.1: การเติบโตของรถยนต์ไฟฟ้าประเภท รย. 1 ตั้งแต่ปี 2022 - 2023
...
![](https://github.com/PNT-tawan/image-for-miniproject-5001/blob/main/Figure%203.5.png)

>Figure 3.3: กราฟแสดงความสัมพันธ์ระหว่างปริมาณการนำเข้าน้ำมันดิบและรถยนต์ไฟฟ้า ตั้งแต่ปี 2020 - 2024

![](https://github.com/PNT-tawan/image-for-miniproject-5001/blob/main/Figure%203.6.png)

>Figure 3.4: กราฟแสดงความสัมพันธ์ระหว่างปริมาณการนำเข้าน้ำมันดิบและรถยนต์ไฟฟ้า ตั้งแต่ปี 2020 - 2024

จากข้อมูลจะเห็นได้ว่า แม้ว่าความนิยมใช้รถยนต์ไฟฟ้าจะเพิ่มขึ้น แต่ยังไม่ส่งผลให้การนำเข้าน้ำมันของประเทศลดลง
...
3. ความนิยมรถยนต์ไฟฟ้าที่เพิ่มขึ้น ส่งผลต่อปริมาณการใช้น้ำมันเบนซินของคนในประเทศและการนำเข้าน้ำมันดิบหรือไม่
